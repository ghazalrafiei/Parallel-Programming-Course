/* As far as possible, comments are provided to explain the code,
 but the code itself, with proper namings is self-explanatory*/
#include <atomic>
#include <ctime>
#include <iostream>
#include <omp.h>
...
#pragma omp parallel for num_threads(4)
  for (int i = 0; i < size; i++) { // parallel for
    std::stack<int> unvisited_vertices;
    marked[i] = true; // mark root as visited
#pragma omp critical
...
#pragma omp critical
      ...
      // Insert all adjacents of the root to the stack
